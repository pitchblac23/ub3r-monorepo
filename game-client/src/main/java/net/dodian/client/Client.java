...
public class Client extends RSApplet {
                        ...
                        if (chatTypeView == 11 || chatTypeView == 0) {
                            ...
                            if (clanChatMode == 0 || (clanChatMode == 1 && isFriendOrSelf(name)) || (chatMessages[k].contains("@cr1@") || chatMessages[k].contains("@cr2@") || myPlayer.name.equalsIgnoreCase(name))) {
                                if (yPos > y && yPos < y + 210) {
                                    ...
                                    //textDrawingArea.method385(0, chatMessages[k].replaceAll("@cr2@", "").replaceAll("@cr1@", ""), yPos, xPos);
                                }
								/*if (clientSize != 0)
    ...
    private void resetLogout() {
        ...
        //settings.put("Announce", "" + announceChatMode);
        //settings.put("Gather", "" + gatherChatMode);
        //clientWidth = clientSize != 0 ? Integer.parseInt(settings.get("Width")) : clientWidth;
        //clientHeight = clientSize != 0 ? Integer.parseInt(settings.get("Height")) : clientHeight;
        toggleSize(0);
        socketStream = null;
        loggedIn = false;
        loginScreenState = 2;
        ...
        if (k1 != 0) {
            ...
            if (class46_2.anInt758 != -1) {
                ...
                if (background_2 != null) {
                    ...
                    int j6 = (ObjectDef.anInt761 * 4 - background_2.anInt1453) / 2;
                    background_2.drawBackground(48 + l * 4 + i6, 48 + (104 - i - ObjectDef.anInt761) * 4 + j6);
                }
            } else {
                if (i3 == 0 || i3 == 2)
                    if (k2 == 0) {
        ...
        if (k1 != 0) {
            ...
            if (class46_1.anInt758 != -1) {
                ...
                if (background_1 != null) {
                    ...
                    int k5 = (ObjectDef.anInt761 * 4 - background_1.anInt1453) / 2;
                    background_1.drawBackground(48 + l * 4 + j5, 48 + (104 - i - ObjectDef.anInt761) * 4 + k5);
                }
            } else if (j3 == 9) {
                int l4 = 0xeeeeee;
                if (k1 > 0)
        ...
        if (k1 != 0) {
            ...
            if (class46.anInt758 != -1) {
                ...
                if (background != null) {
                    ...
                    int j4 = (ObjectDef.anInt761 * 4 - background.anInt1453) / 2;
                    background.drawBackground(48 + l * 4 + i4, 48 + (104 - i - ObjectDef.anInt761) * 4 + j4);
                }
            }
        }
    }
...
//            aRSImageProducer_1108.drawGraphics(371, super.graphics, 202);
    ...
    private boolean method66(int i, int j, int k) {
        ...
        if (k1 == 10 || k1 == 11 || k1 == 22) {
            ...
            if (l1 == 0 || l1 == 2) {
                i2 = class46.anInt744;
                j2 = ObjectDef.anInt761;
            } else {
                i2 = ObjectDef.anInt761;
                j2 = class46.anInt744;
            }
    ...
    private void login(String s, String s1, boolean flag) {
        ...
        try {
            ...
            if (k == 2) {
				...
				/*
				int size = Integer.parseInt(settings.get("screen_mode"));
        ...
        if (j == 147) {
            ...
            if (player != null) {
                ...
                if (model != null) {
                    ...
                    int j23 = ObjectDef.anInt761;
                    if (i20 == 1 || i20 == 3) {
                        i23 = ObjectDef.anInt761;
        ...
        if (i1 >= 1 && i >= 1 && i1 <= 102 && i <= 102) {
            ...
            if (i2 != 0) {
                ...
                if (j1 == 2) {
                    ...
                    if (i1 + class46_1.anInt744 > 103 || i + class46_1.anInt744 > 103 || i1 + ObjectDef.anInt761 > 103 || i + ObjectDef.anInt761 > 103)
                        return;
                    if (class46_1.aBoolean767)
                        aClass11Array1230[j].method216(l2, class46_1.anInt744, i1, i, ObjectDef.anInt761, class46_1.aBoolean757);
                }
                if (j1 == 3) {
