...
public class Client extends RSApplet {
    ...
    public void toggleSize(int size) {
        if (clientSize != size) {
            ...
            if (size == 0) {
                ...
                log_view_dist = 10;
                width = /* isWebclient() ? appletWidth :*/ clientWidth;
                height = /* isWebclient() ? appletHeight :*/clientHeight;
            } else if (size == 2) {
                log_view_dist = 10;
                width = getMaxWidth();
                height = getMaxHeight();
    ...
    public void drawChannelButtons() {
        ...
        if (cButtonHPos == cButtonCPos) {
            switch (cButtonHPos) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    cacheSprite[2].drawSprite(404, y + 142);
                    break;
            }
        } else {
            switch (cButtonHPos) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    cacheSprite[3].drawSprite(404, y + 142);
                    break;
            }
        }
        smallText.method389(true, 425, 0xffffff, "Report Abuse", clientSize == 0 ? 157 : clientHeight - 8);
        smallText.method389(true, 26, 0xffffff, "All", clientSize == 0 ? 157 : clientHeight - 8);
        smallText.method389(true, 86, 0xffffff, "Game", clientSize == 0 ? 157 : clientHeight - 8);
        ...
        smallText.method389(true, 286, 0xffffff, "Yell", clientSize == 0 ? 152 : clientHeight - 12);
    ...
    private void drawChatArea() {
        ...
        if (clientSize != 0 && showChat) {
            ...
            DrawingArea.method335(0xccbb9a, y + 6, 506, 129, 100, 7);
        }
        ...
        if (messagePromptRaised) {
                ...
                if (chatMessages[k] != null) {
                    ...
                    if (chatType == 4
                        ...
                        if (chatTypeView == 3 || chatTypeView == 0) {
                            if (yPos > y && yPos < y + 210)
                                if (clientSize != 0)
                                    newRegularFont.drawBasicString(s1 + " " + chatMessages[k], 11, yPos, 0xff5256, -1);
                                else
                    ...
                    if (chatType == 5 && splitPrivateChat == 0
                        ...
                        if (chatTypeView == 2 || chatTypeView == 0) {
                            if (yPos > y && yPos < y + 210)
                                if (clientSize != 0)
                                    newRegularFont.drawBasicString(chatMessages[k], 11, yPos, 0xff5256, -1);
                                else
                    ...
                    if (chatType == 11) {
                        if (chatTypeView == 11 || chatTypeView == 0) {
                            String msg = chatMessages[k].replaceAll("@cr2@", "").replaceAll("@cr1@", "");
                            String name = msg.contains(">") && msg.contains("<") ? msg.substring(msg.indexOf(">") + 1, msg.indexOf("<", msg.indexOf(">"))) : "";
                            if (clanChatMode == 0 || (clanChatMode == 1 && isFriendOrSelf(name)) || (chatMessages[k].contains("@cr1@") || chatMessages[k].contains("@cr2@") || myPlayer.name.equalsIgnoreCase(name))) {
                                if (yPos > y && yPos < y + 210) {
                                    int xPos = 11;
                                    if (chatMessages[k].contains("@cr1@")) {
                                        modIcons[0].drawBackground(xPos + 1, yPos - 12);
                                        xPos += 14;
                                    } else if (chatMessages[k].contains("@cr2@")) {
                                        modIcons[1].drawBackground(xPos + 1, yPos - 12);
                                        xPos += 14;
                                    }
                                    newRegularFont.drawBasicString(msg, xPos, yPos, 0x7e3200, -1);
                                }
                                amountOfMessages++;
                                //j77++;
                            }
            ...
            if (chatScrollMax < 111)
                chatScrollMax = 111;
            drawScrollbar(114, chatScrollMax - chatScrollPos - 113, 7 + y, 496, chatScrollMax);
            String s;
            ...
            if (clientSize != 0) {
                ...
                textDrawingArea.drawChatInput(255, 12 + textDrawingArea.getTextWidth(s + ": "), inputString + "*", y + 133, false);
    ...
    private void method24(int i) {
        ...
        for (int k2 = 0; k2 < 104; k2++) {
            for (int l2 = 0; l2 < 104; l2++) {
                ...
                if (i3 != 0) {
                    i3 = i3 >> 14 & 0x7fff;
                    int j3 = ObjectDef.forID(i3).mapIcon;
                    if (j3 >= 0) {
                        int k3 = k2;
                        int l3 = l2;
    ...
    private void method26(boolean flag) {
        for (int j = 0; j < npcCount; j++) {
            ...
            if (npc == null || !npc.isVisible() || npc.desc.hadRenderPriority != flag)
                continue;
            int l = npc.x >> 7;
            int i1 = npc.y >> 7;
                                    ...
                                    if (itemSelected == 1 && class9_1.isInventoryInterface) {
                                        ...
                                        if (class9_1.isInventoryInterface) {
                                            for (int l3 = 4; l3 >= 3; l3--)
                                                ...
                                                } else if (itemDef.itemActions != null && itemDef.itemActions[l3] != null) {
                                        ...
                                        if (has_drop_action && shiftIsDown) {
                                            menuActionName[menuActionRow] = "Drop @lre@" + itemDef.name;
                                            menuActionID[menuActionRow] = 847;
                                            menuActionCmd1[menuActionRow] = itemDef.id;
                                            menuActionCmd2[menuActionRow] = k2;
                                        ...
                                        menuActionName[menuActionRow] = "Examine @lre@" + itemDef.name + (this.myPrivilege > 1 ? " (@whi@" + itemDef.id + "@lre@)" : "");
            ...
            for (int j = -1; j < playerCount + npcCount; j++) {
                ...
                if (obj instanceof NPC) {
                    ...
                    if (namesOff) {
                        ...
                        aTextDrawingArea_1271.drawText(0x0099FF, entityDef.name, spriteDrawY + 10, spriteDrawX);
                    }
                ...
                if (j < playerCount) {
                    ...
                    /*Names on heads*/
                    if (namesOff) {
                        npcScreenPos(((Entity) (obj)), ((Entity) (obj)).height + 22);
                        aTextDrawingArea_1271.drawText(0xbb0000, player.name, spriteDrawY -10, spriteDrawX);
                    }
                } else {
    ...
    private void resetLogout() {
        ...
        settings.put("screen_mode", "" + clientSize);
        ...
        if (k1 != 0) {
            ...
            if (class46_2.mapscene != -1) {
                ...
                if (background_2 != null) {
                    ...
                    int j6 = (ObjectDef.length * 4 - background_2.anInt1453) / 2;
                    background_2.drawBackground(48 + l * 4 + i6, 48 + (104 - i - ObjectDef.length) * 4 + j6);
                }
            } else {
                if (i3 == 0 || i3 == 2)
                    if (k2 == 0) {
        ...
        if (k1 != 0) {
            ...
            if (class46_1.mapscene != -1) {
                ...
                if (background_1 != null) {
                    ...
                    int k5 = (ObjectDef.length * 4 - background_1.anInt1453) / 2;
                    background_1.drawBackground(48 + l * 4 + j5, 48 + (104 - i - ObjectDef.length) * 4 + k5);
                }
            } else if (j3 == 9) {
                int l4 = 0xeeeeee;
                if (k1 > 0)
        ...
        if (k1 != 0) {
            ...
            if (class46.mapscene != -1) {
                ...
                if (background != null) {
                    ...
                    int j4 = (ObjectDef.length * 4 - background.anInt1453) / 2;
                    background.drawBackground(48 + l * 4 + i4, 48 + (104 - i - ObjectDef.length) * 4 + j4);
                }
            }
        }
    }
...
//        aBackground_966 = new Background(titleStreamLoader, "titlebox", 0);
    ...
    private boolean inDuelArenaFightArea(int x, int y) {
    ...
    private boolean inDuelArenaOutskirt(int x, int y) {
        return (x >= 3328 && x <= 3395 && y >= 3200 && y <= 3287);
    }

    private boolean inWilderness(int x, int y) {
        return (x > 2941 && x < 3392 && y >= 3525 && y < 3970) || (x > 2941 && x < 3392 && y > 9918 && y < 10366);
    }

    private boolean inBarrows(int x, int y, int z) {
        return (x > 3539 && x < 3582 && y >= 9675 && y < 9722);
    }

    private boolean inFightPits(int x, int y) {
    ...
    private void mainGameProcessor() {
        ...
        if (!walkableInterfaceMode) {
            if (inWilderness(baseX + (myPlayer.x - 6 >> 7), baseY + (myPlayer.y - 6 >> 7))) {
                ...
                atPlayerArray[1] = false;
                anInt1018 = 2804;
            } else if (inBarrows(baseX + (myPlayer.x - 6 >> 7), baseY + (myPlayer.y - 6 >> 7), plane)) {
                anInt1018 = 4535;
        ...
        anInt1055 = (inMultiArea(baseX + (myPlayer.x - 6 >> 7), baseY + (myPlayer.y - 6 >> 7)) ? 1 : 0);
...
//            aRSImageProducer_1108.drawGraphics(371, super.graphics, 202);
            ...
            if (class30_sub2_sub4_sub1_sub1_5 != null) {
                ...
                if (entityDef != null) {
                    if (entityDef.combatLevel > 0) {
                        String test = "loot_new " + entityDef.interfaceType + " 1000";
                        stream.createFrame(103);
                        stream.writeWordBigEndian(test.length() + 1);
                        stream.writeString(test);
                    } else
                        pushMessage("It's a " + entityDef.name + ".", 0, "");
                }
            }
        }
        if (l == 900) {
                ...
                if (class19 != null) {
                    for (Item item = (Item) class19.getFirst(); item != null; item = (Item) class19.getNext()) {
                        ...
                        if (itemSelected == 1) {
                            ...
                            menuActionName[menuActionRow] = "Examine @lre@" + itemDef.name + (myPrivilege >= 2 ? " (@whi@" + itemDef.id + "@lre@)" : "");
    ...
    public void tabToReplyPm() {
        ...
        if (k3 != -1) {
            ...
            pushMessage("That player is not on your friendslist!", 0, "");
    }

    private void method73() {
        do {
            int j = readChar(-796); //CharId
            if (j == -1)
                break;
            /* Setting key for chat dialogue */
            boolean checkDialogue = backDialogID == 4882 || backDialogID == 4887 || backDialogID == 4893 || backDialogID == 4900 ||
                    backDialogID == 968 || backDialogID == 973 || backDialogID == 979 || backDialogID == 986;
            boolean checkOptionDialogue = backDialogID == 2492 || backDialogID == 2480 || backDialogID == 2469 || backDialogID == 2459;
            if (j >= 49 && j <= 53 && checkOptionDialogue) {
                int index = j - 49;
                int packet = backDialogID == 2480 ? 2482 : backDialogID == 2469 ? 2471 :
                        backDialogID == 2459 ? 2461 : backDialogID == 2492 ? 2494 : 0;
                if (packet != 0) {
                    stream.createFrame(185);
                    sendFrame126("Please wait...", packet + index);
                    stream.writeWord(packet + index);
                }
            } else if (j == 32 && checkDialogue) {
                stream.createFrame(40);
                sendFrame126("Please wait...", backDialogID + (backDialogID == 4882 || backDialogID == 968 ? 4 : backDialogID == 4887 || backDialogID == 973 ? 5 :
                        backDialogID == 4893 || backDialogID == 979 ? 6 : 7));
                stream.writeWord(backDialogID);
                /* End of Setting key */
                ...
                if ((j == 13 || j == 10) && inputString.length() > 0) {
                    if (myPrivilege == 2 || myPrivilege == 3 || server.equals("127.0.0.1")) {
                    ...
                    if (inputString.equals("::roofs")) {
                        roofsOff = !roofsOff;
                        if (roofsOff) {
                            pushMessage("@gre@Roof's off", 0, "");
                        } else {
                            pushMessage("@red@Roof's on", 0, "");
                        }
                    }
                    ...
                    if (inputString.startsWith("::") || inputString.startsWith("/")) {
                        ...
                        if (inputString.startsWith("/"))
                            index = 1;
                        String command = inputString.substring(index);
                        stream.createFrame(103);
    ...
    private void rightClickChatButtons() {
        ...
        if (super.mouseX >= 5 && super.mouseX <= 61 && super.mouseY >= y + 482 && super.mouseY <= y + 503) {
            ...
            menuActionName[1] = "Off yell chat";
            menuActionID[1] = 1003;
            menuActionName[2] = "Friends yell chat";
            menuActionID[2] = 1002;
            menuActionName[3] = "On yell chat";
            menuActionID[3] = 1001;
            menuActionName[4] = "View yell chat";
            menuActionID[4] = 1000;
            menuActionRow = 5;
        } else if (super.mouseX >= 335 && super.mouseX <= 391 && super.mouseY >= y + 482 && super.mouseY <= y + 503) {
    ...
    private void buildAtNPCMenu(EntityDef entityDef, int i, int j, int k) {
        ...
        if (spellSelected == 1) {
            ...
            menuActionName[menuActionRow] = "Examine @yel@" + s + (myPrivilege >= 2 ? "@whi@ - " + entityDef.interfaceType + ":@red@" + i : "");
    ...
    void startUp() {
        ...
        try {
            ...
            /* Set orbs*/
            hitPointsFill = new Sprite(streamLoader_2, "Orbs", 0);
            hitPointsBg = new Sprite(streamLoader_2, "Orbs", 2);
            heartIcon = new Sprite(streamLoader_2, "Orbs", 4);
            prayerFill = new Sprite(streamLoader_2, "Orbs", 1);
            prayerBg = new Sprite(streamLoader_2, "Orbs", 3);
            ...
            if (loadingStage == 2) {
                ...
                if (openInterfaceID != -1) {
                    ...
                    if (rsInterface_1.width == 512 && rsInterface_1.height == 334 && rsInterface_1.type == 0) {
                        rsInterface_1.width = clientWidth;
                        rsInterface_1.height = clientHeight;
                    }
                    drawInterface(0, clientSize == 0 ? 0 : (clientWidth / 2) - 503 / 2, rsInterface_1,
                            clientSize == 0 ? 8 : (clientHeight / 2) - 383 / 2);
                }
                RSInterface rsInterface = RSInterface.interfaceCache[fullscreenInterfaceID];
                if (rsInterface.width == 512 && rsInterface.height == 334 && rsInterface.type == 0) {
                    rsInterface.width = clientWidth;
                    rsInterface.height = clientHeight;
                }
                drawInterface(0, clientSize == 0 ? 0 : (clientWidth / 2) - 400 / 2, rsInterface,
                        clientSize == 0 ? 8 : (clientHeight / 2) - 383 / 2);
            }
            drawCount++;
    ...
    private void draw3dScreen() {
        ...
        if(anInt1018 != -1) {
            ...
            if (clientSize == 0)
                ...
                if (clientWidth >= 900 && clientHeight >= 650) {
                    drawInterface(0, (clientWidth / 2) - 356, RSInterface.interfaceCache[anInt1018], clientHeight / 2 - 230);
                } else {
                    drawInterface(0, 0, RSInterface.interfaceCache[anInt1018], 0);
                }
            }
        ...
        if (fpsOn) {
            ...
            if (super.fps < 15)
                i1 = 0xff0000;
            aTextDrawingArea_1271.method380("FPS: " + super.fps, clientSize == 0 ? 500 : clientWidth - 230, i1, k);
            k += 15;
            ...
            if (j1 > 0x2000000 && lowMem)
                i1 = 0xff0000;
            aTextDrawingArea_1271.method380("Mem:" + j1 + "k", clientSize == 0 ? 500 : clientWidth - 230, 0xffff00, k);
            k += 15;
        }
        ...
        if (anInt1104 != 0) {
            ...
            j %= 60;
            if (j < 10)
                aTextDrawingArea_1271.method385(0xffff00, "Server restart in: " + l + ":0" + j, 329, 4);
            else
                aTextDrawingArea_1271.method385(0xffff00, "Server restart in: " + l + ":" + j, 329, 4);
            anInt849++;
            if (anInt849 > 75) {
                anInt849 = 0;
    ...
    private int extractInterfaceValues(RSInterface rsInterface, int scriptId) {
        //System.out.println("Script: " + rsInterface.id + ":" + scriptId);
        if (rsInterface.scripts == null || scriptId >= rsInterface.scripts.length)
            return -2;
        try {
            int[] script = rsInterface.scripts[scriptId];
            int acc = 0;
            int pos = 0;
            int arith = 0;
            do {
                ...
                if (code == 0)
                    return acc;
                if (code == 1)
                    register = currentStats[script[pos++]];
                if (code == 2)
                    register = maxStats[script[pos++]];
                if (code == 3) {
                    register = currentExp[script[pos++]];
                }
                if (code == 4) {
                    RSInterface class9_1 = RSInterface.interfaceCache[script[pos++]];
                    int k2 = script[pos++];
                    if (k2 >= 0 && k2 < ItemDef.totalItems && (!ItemDef.forID(k2).membersObject || isMembers)) {
                        for (int j3 = 0; j3 < class9_1.inv.length; j3++)
                            if (class9_1.inv[j3] == k2 + 1)
                                register += class9_1.invStackSizes[j3];
                    }
                }
                if (code == 5)
                    register = variousSettings[script[pos++]];
                if (code == 6)
                    register = anIntArray1019[maxStats[script[pos++]] - 1];
                if (code == 7)
                    register = (variousSettings[script[pos++]] * 100) / 46875;
                if (code == 8)
                    register = myPlayer.combatLevel;
                if (code == 9) {
                    for (int l1 = 0; l1 < Skills.skillsCount; l1++)
                        if (Skills.skillEnabled[l1])
                            register += maxStats[l1];

                }
                if (code == 10) {
                    RSInterface class9_2 = RSInterface.interfaceCache[script[pos++]];
                    int l2 = script[pos++] + 1;
                ...
                if (code == 12)
                    register = weight;
                if (code == 13) {
                    int i2 = variousSettings[script[pos++]];
                    int i3 = script[pos++];
                    register = (i2 & 1 << i3) == 0 ? 0 : 1;
                }
                if (code == 14) {
                    int j2 = script[pos++];
                    ...
                    register = variousSettings[l3] >> i4 & k4;
                }
                if (code == 15)
                    nextArith = 1;
                if (code == 16)
                ...
                if (code == 17)
                    nextArith = 3;
                if (code == 18)
                    register = (myPlayer.x >> 7) + baseX;
                if (code == 19)
                    register = (myPlayer.y >> 7) + baseY;
                if (code == 20)
                    register = script[pos++];
                if (nextArith == 0) {
                    if (arith == 0)
    ...
    private void drawMinimap() {
        ...
        minimapImage.method352(151, i, anIntArray1229, 256 + minimapInt3, anIntArray1052, l2, (clientSize == 0 ? 9 : 12), (clientSize == 0 ? 59 - 5 : clientWidth + 59 - 5 - 238), 146, j);
        ...
        if (j == 147) {
            ...
            if (player != null) {
                ...
                if (model != null) {
                    ...
                    int j23 = ObjectDef.length;
                    if (i20 == 1 || i20 == 3) {
                        i23 = ObjectDef.length;
                        j23 = class46.width;*/
                    int i23 = class46.width;
                    int j23 = ObjectDef.length;
                    if (i20 == 1 || i20 == 3) {
        ...
        if (i1 >= 1 && i >= 1 && i1 <= 102 && i <= 102) {
            ...
            if (i2 != 0) {
                ...
                if (j1 == 2) {
                    ...
                    if (i1 + class46_1.width > 103 || i + class46_1.width > 103 || i1 + ObjectDef.length > 103 || i + ObjectDef.length > 103)
                        return;
                    if (class46_1.solid)
                        aClass11Array1230[j].method216(l2, class46_1.width, i1, i, ObjectDef.length, class46_1.impenetrable);
                }
                if (j1 == 3) {
        ...
        try {
            ...
            switch (pktType) {
                ...
                case 253:
                    ...
                    } else if (s.endsWith(":yell:")) {
                        String msg = s.substring(0, s.indexOf(":yell:"));
                        pushMessage(msg, 11, "");
            ...
            StringBuilder s2 = new StringBuilder("T2 - " + pktType + "," + anInt842 + "," + anInt843 + " - " + pktSize + "," + (baseX + myPlayer.smallX[0]) + "," + (baseY + myPlayer.smallY[0]) + " - ");
            for (int j15 = 0; j15 < pktSize && j15 < 50; j15++)
                s2.append(inStream.buffer[j15]).append(",");
    ...
    private void method146() {
        ...
        if (!aBoolean1160) {
            ...
            setCameraPos(cameraPos2 + i * (clientSize == 0 ? cameraPos1 : 5) * zoom, i, anInt1014, method42(plane, myPlayer.y, myPlayer.x) - 50, k, anInt1015);
        }
        int j;
        if (!aBoolean1160)
            j = method120();
    ...
    public Sprite[] chatImages = new Sprite[iconSize];
    /**/
    ...
    private final int smallTabs = 1000;
    ...
    private static boolean roofsOff;
    private static boolean namesOff;
    ...
    private final Background[] modIcons = new Background[iconSize];
