...
import net.dodian.old.uber.game.model.combat.impl.styles.AxeHandler;
import net.dodian.old.uber.game.model.combat.impl.styles.BowHandler;
import net.dodian.old.uber.game.model.combat.impl.styles.HalberdHandler;
import net.dodian.old.uber.game.model.combat.impl.styles.HammerHandler;
import net.dodian.old.uber.game.model.combat.impl.styles.LongSwordsHandler;
import net.dodian.old.uber.game.model.combat.impl.styles.MaceHandler;
import net.dodian.old.uber.game.model.combat.impl.styles.PickaxeHandler;
import net.dodian.old.uber.game.model.combat.impl.styles.SpearHandler;
import net.dodian.old.uber.game.model.combat.impl.styles.SwordsHandler;
import net.dodian.old.uber.game.model.combat.impl.styles.ThrowableHandler;
import net.dodian.old.uber.game.model.combat.impl.styles.UnarmedHandler;
import net.dodian.old.uber.game.model.combat.impl.styles.WandHandler;
import net.dodian.old.uber.game.model.combat.impl.styles.WhipHandler;
