...
public class Constants {
    ...
    public static int[][][] smithing_frame = {
            {{1205, 1, 1, 1, 1125, 1094}/*0*/, {1351, 1, 1, 1, 1126, 1091}/*1*/, {1422, 1, 2, 1, 1129, 1093}/*2*/,
                    {1139, 1, 3, 1, 1127, 1102}/*3*/, {1277, 1, 3, 1, 1128, 1085}/*4*/, {819, 10, 4, 1, 1124, 1107}/*4*/,
                    {4819, 15, 4, 1, 13357, 13358}/*6*/, {39, 15, 5, 1, 1130, 1108}/*7*/, {1321, 1, 5, 2, 1116, 1087}/*8*/,
                    {1291, 1, 6, 2, 1089, 1086}/*9*/, {1155, 1, 7, 2, 1113, 1103}/*10*/, {864, 5, 7, 1, 1131, 1106}/*11*/,
                    {1173, 1, 8, 2, 1114, 1104}/*12*/, {1337, 1, 9, 3, 1118, 1083}/*13*/, {1375, 1, 10, 3, 1095, 1092}/*14*/,
                    {1103, 1, 11, 3, 1109, 1098}/*15*/, {1189, 1, 12, 3, 1115, 1105}/*16*/, {3095, 1, 13, 2, 8428, 8429}/*17*/,
                    {1307, 1, 14, 3, 1090, 1088}/*18*/, {1087, 1, 16, 3, 1111, 1100}/*19*/, {1075, 1, 16, 3, 1110, 1099}/*20*/,
                    {1117, 1, 18, 5, 1112, 1101}/*21*/, /* Specials */{1794, 1, 4, 1, 1132, 1096}},/*Bronze*/
            {{1203, 1, 15, 1, 1125, 1094}, {1349, 1, 16, 1, 1126, 1091}, {1420, 1, 17, 1, 1129, 1093},
                    ...
                    {1115, 1, 33, 5, 1112, 1101}, /* Specials */{1267, 1, 16, 1, 11459, 11461}},/*Iron*/
            {{1207, 1, 30, 1, 1125, 1094}, {1353, 1, 31, 1, 1126, 1091}, {1424, 1, 32, 1, 1129, 1093},
                    ...
                    {1119, 1, 48, 5, 1112, 1101}, /* Specials */{1269, 1, 31, 1, 11459, 11461},
                    {2370, 1, 36, 1, 1135, 1134}},/*Steel*/
            {{1209, 1, 50, 1, 1125, 1094}, {1355, 1, 51, 1, 1126, 1091}, {1428, 1, 52, 1, 1129, 1093},
                    ...
                    {1121, 1, 68, 5, 1112, 1101}, /* Specials */{1273, 1, 51, 1, 11459, 11461}},/*Mith*/
            {{1211, 1, 70, 1, 1125, 1094}, {1357, 1, 71, 1, 1126, 1091}, {1430, 1, 72, 1, 1129, 1093},
                    ...
                    {1123, 1, 88, 5, 1112, 1101}, /* Specials */{1271, 1, 71, 1, 11459, 11461}},/*Adamant*/
            {{1213, 1, 85, 1, 1125, 1094}, {1359, 1, 86, 1, 1126, 1091}, {1432, 1, 87, 1, 1129, 1093},
                    ...
                    {1127, 1, 99, 5, 1112, 1101}, /* Specials */{1275, 1, 86, 1, 11459, 11461}}};/*Rune*/
