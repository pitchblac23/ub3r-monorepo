...
public abstract class CombatStyleHandler {
    ...
    public enum CombatStyles {
        ACCURATE_MELEE, AGGRESSIVE_MELEE, DEFENSIVE_MELEE, CONTROLLED_MELEE,
        ACCURATE_RANGED, RAPID_RANGED, LONGRANGE_RANGED,
        ATTACK_WITH_SPELL, ATTACK_WITH_SPELL_DEFENCE
    }
}