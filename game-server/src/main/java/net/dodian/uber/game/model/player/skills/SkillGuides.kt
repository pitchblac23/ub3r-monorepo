    ...
    companion object {
        ...
        fun showSkillMenu(skillID: Int, child: Int, player: Client) {
            ...
            if (skillID == Skills.ATTACK.id) {
                ...
                slot = 8760
                val s = arrayOf("Abyssal Whip", "Bronze", "Iron", "Steel", "Mithril", "Adamant", "Rune", "Unholy book", "Unholy blessing", "Granite longsword", "Obsidian weapon", "Dragon", "Skillcape")
                ...
                player.changeInterfaceStatus(8813, false)
                slot = 8760
                val s = arrayOf("Skeletal", "Bronze", "Iron", "Steel", "Mithril", "Splitbark", "Adamant", "Rune", "Ancient blessing", "Granite", "Obsidian", "Dragon", "Crystal shield (with 60 agility)", "Dragonfire shield", "Skillcape")
                ...
                player.changeInterfaceStatus(8813, false)
                slot = 8760
                val s = arrayOf("Shrimps (3 health)", "Rat meat (3 health)", "Bread (5 health)", "Thin snail (7 health)", "Trout (8 health)", "Salmon (10 health)", "Lobster (12 health)", "Swordfish (14 health)", "Monkfish (16 health)", "Shark (20 health)", "Sea Turtle (22 health)", "Manta Ray (24 health)")
                for (i in s.indices) { player.send(SendString(s[i], slot + i)) }
                ...
                if (child == 0) {
                    s = arrayOf("Oak bow", "Willow bow", "Maple bow", "Yew bow", "Magic bow", "Crystal bow", "Seercull" /*, "Twisted bow"*/)
                    s1 = arrayOf("1", "20", "30", "40", "50", "65", "75" /*, "85"*/)
                } else if (child == 1) {
                    s = arrayOf("Leather", "Green dragonhide body (with 40 defence)", "Green dragonhide chaps", "Green dragonhide vambraces", "Book of balance", "Peaceful blessing", "Honourable blessing", "Blue dragonhide body (with 40 defence)", "Blue dragonhide chaps", "Blue dragonhide vambraces", "Red dragonhide body (with 40 defence)", "Red dragonhide chaps", "Red dragonhide vambraces", "Black dragonhide body (with 40 defence)", "Black dragonhide chaps", "Black dragonhide vambraces", "Spined")
                    s1 = arrayOf("1", "40", "40", "40", "45", "45", "45", "50", "50", "50", "60", "60", "60", "70", "70", "70", "75")
                } else if (child == 2) {
                    s = arrayOf("Bronze arrow", "Iron arrow", "Steel arrow", "Mithril arrow", "Adamant arrow", "Rune arrow", "Dragon arrow", "Skillcape")
                ...
                var s1 = arrayOfNulls<String>(0)
                if (child == 0) {
                    s = arrayOf("High Alch", "Smoke Rush", "Enchant Sapphire", "Shadow Rush", "Blood Rush", "Enchant Emerald", "Ice Rush", "Smoke Burst", "Superheat", "Enchant Ruby", "Shadow Burst", "Enchant Diamond", "Blood Burst", "Enchant Dragonstone", "Ice Burst", "Smoke Blitz", "Shadow Blitz", "Blood Blitz", "Ice Blitz", "Smoke Barrage", "Enchant Onyx", "Shadow Barrage", "Blood Barrage", "Ice Barrage")
                    s1 = arrayOf("1", "1", "7", "10", "20", "27", "30", "40", "43", "49", "50", "57", "60", "68", "70", "74", "76", "80", "82", "86", "87", "88", "92", "94")
                } else if (child == 1) {
                    s = arrayOf("Blue Mystic", "White Mystic", "Splitbark (with 20 defence)", "Black Mystic", "Holy book", "Holy blessing", "Infinity")
                    s1 = arrayOf("1", "20", "20", "35", "45", "45", "50")
                } else if (child == 2) {
                    s = arrayOf("Zamorak staff", "Saradomin staff", "Guthix staff", "Ancient staff", "Obsidian staff", "Master wand", "Skillcape")
                    s1 = arrayOf("1", "1", "1", "25", "40", "50", "99")
                }
                for (i in s.indices) { player.send(SendString(s[i], slot + i)) }
                slot = 8720
                for (i in s1.indices) { player.send(SendString(s1[i], slot + i)) }
                if (child == 0) player.setMenuItems(intArrayOf(561, 565, 564, 565, 565, 564, 565, 565, 561, 564, 565, 564, 565, 564, 565, 565, 565, 565, 565, 565, 564, 565, 565, 565),
                ...
                var s1 = arrayOfNulls<String>(0)
                if (child == 0) {
                    s = arrayOf("Bronze Axe", "Iron Axe", "Steel Axe", "Mithril Axe", "Adamant Axe", "Rune Axe", "Dragon Axe")
                ...
                player.changeInterfaceStatus(8813, false)
                slot = 8760
                val s = arrayOf("Arrow Shafts", "Oak Shortbow", "Oak Longbow", "Willow Shortbow", "Willow Longbow", "Maple Shortbow", "Maple Longbow", "Yew Shortbow", "Yew Longbow", "Magic Shortbow", "Magic Longbow")
                ...
                if (child == 0) {
                    ...
                    s = arrayOf("Leather gloves", "Leather boots", "Leather cowl", "Leather vambraces", "Leather body", "Leather chaps", "Coif", "Green d'hide vamb", "Green d'hide chaps", "Green d'hide body", "Blue d'hide vamb", "Blue d'hide chaps", "Blue d'hide body", "Red d'hide vamb", "Red d'hide chaps", "Red d'hide body", "Black d'hide vamb", "Black d'hide chaps", "Black d'hide body")
                    s1 = arrayOf("1", "7", "9", "11", "14", "18", "39", "50", "54", "58", "62", "66", "70", "73", "76", "79", "82", "85", "88")
                } else if (child == 2) {
                    s = arrayOf("Gold ring", "Gold necklace", "Gold bracelet", "Gold amulet", "Cut sapphire", "Sapphire ring", "Sapphire necklace", "Sapphire bracelet", "Sapphire amulet", "Cut emerald", "Emerald ring", "Emerald necklace", "Emerald bracelet", "Emerald amulet", "Cut ruby", "Ruby ring", "Ruby necklace", "Ruby bracelet", "Cut diamond", "Diamond ring", "Ruby amulet", "Cut dragonstone", "Dragonstone ring", "Diamond necklace", "Diamond bracelet", "Cut onyx", "Onyx ring", "Diamond amulet", "Dragonstone necklace", "Dragonstone bracelet", "Dragonstone amulet", "Onyx necklace", "Onyx bracelet", "Onyx amulet")
                    s1 = arrayOf("5", "6", "7", "8", "20", "20", "22", "23", "24", "27", "27", "29", "30", "31", "34", "34", "40", "42", "43", "43", "50", "55", "55", "56", "58", "67", "67", "70", "72", "74", "80", "82", "84", "90")
                } else if (child == 3) {
                    s = arrayOf("Skillcape")
                    s1 = arrayOf("99")
                }
                ...
                slot = 8720
                for (i in s1.indices) { player.send(SendString(s1[i], slot + i)) }
                if (child == 0) player.setMenuItems(intArrayOf(1759, 1777)) else if (child == 1) player.setMenuItems(intArrayOf(1059, 1061, 1167, 1063, 1129, 1095, 1169, 1065, 1099, 1135, 2487, 2493, 2499, 2489, 2495, 2501, 2491, 2497, 2503))
                ...
                var s1 = arrayOfNulls<String>(0)
                if (child == 0) {
                    s = arrayOf("Bronze Pickaxe", "Iron Pickaxe", "Steel Pickaxe", "Mithril Pickaxe", "Adamant Pickaxe", "Rune Pickaxe", "Dragon Pickaxe")
                    s1 = arrayOf("1", "1", "6", "21", "31", "41", "61")
                } else if (child == 1) {
                    s = arrayOf("Rune essence", "Copper ore", "Tin ore", "Iron ore", "Coal", "Gold ore", "Mithril ore", "Adamant ore", "Runite ore")
                ...
                player.changeInterfaceStatus(8813, false)
                slot = 8760
                val s = arrayOf("Gnome Course", "Barbarian Course", "Yanille castle wall", "Crystal Shield", "Taverly dungeon shortcut", "Wilderness course", "Prime boss shortcut", "Skillcape")
                ...
                player.changeInterfaceStatus(8813, false)
                slot = 8760
                val s = arrayOf("Cage", "Farmer", "Baker stall", "fur stall", "silver stall", "Master Farmer", "Yanille chest", "Spice Stall", "Legends chest", "Gem Stall")
                ...
                if (child == 0) {
                    ...
                    s = arrayOf("Crawling hands", "Pyrefiend", "Albino bat", "Death spawn", "Jelly", "Head mourner", "Jungle horrors", "Skeletal hellhound", "Lesser demon", "Bloodvelds", "Greater demon", "Black demon", "Gargoyles", "Cave horrors", "Berserker Spirit", "Aberrant Spectres", "Tzhaar", "Mithril Dragon", "Abyssal demon", "Dagannoth Prime")
